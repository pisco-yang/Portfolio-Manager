...
-- Table 3: Price History (optional for graphing or price tracking)
-- Apple price history
CREATE TABLE IF NOT EXISTS price_history_aapl (
  id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS price_history_nvda (
  id INT AUTO_INCREMENT PRIMARY KEY,
  price FLOAT NOT NULL,
  date DATE NOT NULL
);

-- US Treasury Bond 10Y price history
CREATE TABLE IF NOT EXISTS price_history_t_bond10y (
  id INT AUTO_INCREMENT PRIMARY KEY,
  price FLOAT NOT NULL,
  date DATE NOT NULL
);
...
INSERT INTO portfolio (asset_type, asset_name, symbol, quantity, average_purchase_price, current_price)
VALUES 
...
-- AAPL
INSERT INTO price_history_aapl (price, date)
VALUES
(175.00, '2025-07-05'),
(180.00, '2025-07-10');

-- NVDA
INSERT INTO price_history_nvda (price, date)
VALUES
(460.00, '2025-07-05'),
(470.00, '2025-07-10');

-- T-BOND10Y
INSERT INTO price_history_t_bond10y (price, date)
VALUES
(995.00, '2025-07-10');
